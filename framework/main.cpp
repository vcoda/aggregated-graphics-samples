...
void error(const std::string& msg, const char *caption)
{
    std::cerr << msg << std::endl;
#ifdef _WIN32
    MessageBoxA(NULL, msg.c_str(), caption, MB_ICONHAND);
#else
    MAGMA_UNUSED(caption);
#endif
}
