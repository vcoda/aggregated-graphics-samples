...
Win32App::Win32App(const AppEntry& entry, const core::tstring& caption, uint32_t width, uint32_t height):
...
void Win32App::setWindowCaption(const core::tstring& caption)
{
