...
XlibApp::XlibApp(const AppEntry& entry, const core::tstring& caption, uint32_t width, uint32_t height):
...
void XlibApp::setWindowCaption(const core::tstring& caption)
{
